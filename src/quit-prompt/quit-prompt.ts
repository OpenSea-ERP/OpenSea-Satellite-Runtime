...
export async function showQuitPrompt(
  options: ShowQuitPromptOptions,
): Promise<"minimize" | "quit"> {
  ...
  const { response, checkboxChecked } = await dialog.showMessageBox(
    options.win,
    {
      ...
      detail:
        "Minimizar mantém o app rodando na bandeja do sistema. Sair fecha o app completamente.",
