...
describe("store module", () => {
  ...
  it("forwards migrations to electron-store", async () => {
    const ElectronStoreMock = (await import("electron-store")).default as ReturnType<
      typeof vi.fn
    >;
    ...
    const constructorArgs = ElectronStoreMock.mock.calls[ElectronStoreMock.mock.calls.length - 1]?.[0];
